            ...
            <div className="bg-white rounded-2xl shadow-xl p-8 md:p-12 mb-8">
              ...
              <ul className="space-y-4 text-gray-700">
                ...
                <li className="flex items-start">
                  ...
                  <div>
                    <strong className="text-gray-900">Expert care</strong> - 2000+ families trust us as their best dog groomer in Madison with over 8 years serving the Cherokee Marsh community
                  </div>
                </li>
              </ul>
            </div>
