        ...
        <section ref={heroRef} className="relative h-screen flex items-center justify-center overflow-hidden">
          ...
          <div className="absolute inset-0 z-0">
            <Image
              ...
              alt="Doodle building developing athletic endurance through acres of purpose-built adventure trails serving Sun Prairie community with River Paws"object-cover"
