    ...
    <>
      ...
      <section ref={heroRef} className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="absolute inset-0 z-0">
          <Image
            ...
            alt="Professional dog grooming service near you at River Paws in Waunakee, Wisconsin serving Madison, Middleton, DeForest, and Sun Prairie"
            fill
        ...
        <div className="relative z-[50] max-w-7xl mx-auto px-4 sm:px-6 text-center">
          <div className="space-y-6 sm:space-y-8">
            ...
            <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-8xl font-bold leading-tight px-2">
              ...
              <span className="block text-white animate-fadeInUp-delay-600 drop-shadow-2xl">Royal Treatment</span>
          </h1>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-2xl transform hover:-translate-y-2 transition-all duration-300">
              ...
              <p className="text-gray-600 leading-relaxed mt-4">
                <strong>Conveniently Located Next to Yahara Heights Dog Park</strong> - Just 500 feet from Yahara Heights' 20-acre off-leash area, we're the perfect solution for post-dog park grooming. Clean up your muddy pup after Cherokee Marsh adventures or Yahara River swimming sessions. Walking distance from the area's most popular dog park!
              </p>
            </div>
      ...
      <section className="py-24 px-6 bg-gradient-to-b from-blue-50 to-white">
        <div className="max-w-7xl mx-auto">
          ...
          {/* Blog Section */}
          <div className="mt-8 sm:mt-12 bg-gradient-to-r from-purple-50 to-pink-50 rounded-2xl sm:rounded-3xl p-6 sm:p-8 md:p-12 border border-purple-100">
            ...
            <div className="text-center">
              <Link
                href="/blog"
                className="inline-flex items-center bg-gradient-to-r from-purple-600 to-pink-600 text-white px-6 py-3 rounded-lg font-semibold hover:from-purple-700 hover:to-pink-700 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1"
              >
                View All Articles
          ...
          <div className="mt-8 sm:mt-12 bg-white rounded-2xl sm:rounded-3xl p-6 sm:p-8 md:p-12 shadow-lg border border-gray-100">
            ...
            <div className="grid md:grid-cols-2 gap-6 max-w-2xl mx-auto">
              <Link
                href="/dog-hikes"
                className="bg-gradient-to-r from-emerald-50 to-teal-50 rounded-xl p-6 hover:shadow-lg transition-all duration-300 group border border-emerald-100"
              >
              ...
              <Link
                href="/caretakers"
                className="bg-gradient-to-r from-blue-50 to-teal-50 rounded-xl p-6 hover:shadow-lg transition-all duration-300 group border border-blue-100"
              >
                <div className="flex items-center gap-3 mb-3">
            ...
            <div className="mt-12 pt-12 border-t border-gray-200">
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                <Link
                  ...
                  className="bg-white rounded-xl p-6 shadow-md hover:shadow-xl transform hover:-translate-y-1 transition-all duration-300 group"
                >
                  <div className="mb-4">
              ...
              <div className="text-center mt-8">
                <Link
                  href="/blog"
                  className="inline-flex items-center px-6 py-3 bg-gradient-to-r from-emerald-600 to-teal-600 text-white rounded-lg font-semibold hover:from-emerald-700 hover:to-teal-700 transition-all duration-300 shadow-md hover:shadow-lg"
                >
