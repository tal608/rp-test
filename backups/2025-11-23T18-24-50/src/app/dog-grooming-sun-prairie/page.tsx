      ...
      <main className="min-h-screen bg-gradient-to-b from-white to-blue-50">
        ...
        <section ref={heroRef} className="relative h-screen flex items-center justify-center overflow-hidden">
          ...
          <div className="absolute inset-0 z-0">
            <Image
              ...
              alt="Dog grooming Sun Prairie - Professional dog grooming services at River Paws serving Sun Prairie, Wisconsin"
              fill
        ...
        <section className="py-12 sm:py-16 px-4 sm:px-6">
          <div className="max-w-7xl mx-auto">
            ...
            {/* Call to Action */}
            <div className="mt-12 bg-gradient-to-r from-emerald-600 to-teal-600 rounded-2xl sm:rounded-3xl p-6 sm:p-8 md:p-12 text-white text-center">
