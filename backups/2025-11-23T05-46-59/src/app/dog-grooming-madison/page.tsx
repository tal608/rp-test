      ...
      <main className="min-h-screen bg-gradient-to-b from-white to-blue-50">
          ...
          <div className="relative z-[50] max-w-7xl mx-auto px-4 sm:px-6 text-center">
            <div className="space-y-6 sm:space-y-8">
              ...
              <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-white/95 max-w-4xl mx-auto animate-fadeInUp-delay-800 px-4" style={{ textShadow: '0 2px 10px rgba(0,0,0,0.8)' }}>
                Looking for dog grooming Madison? Professional dog grooming services for Madison families. Expert groomers providing
                full-service grooming, breed-specific styling, and compassionate care since 2017. Conveniently located just north of Madison via Highway 113/Northport Drive, 10 minutes from North Madison, near Cherokee Marsh Conservation Park.
              </p>
        ...
        <section className="py-16 px-6">
          <div className="max-w-4xl mx-auto">
            ...
            {/* Why River Paws is the Best Dog Groomer in Madison */}
            <div className="bg-white rounded-2xl shadow-xl p-8 md:p-12 mb-8">
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
                Why River Paws is the Best Dog Groomer in Madison
              </h2>
              <p className="text-lg text-gray-700 leading-relaxed mb-4">
                Searching for the best dog groomer Madison? Here's why families choose us as their trusted grooming partner:
              </p>
              <ul className="space-y-4 text-gray-700">
                ...
                <li className="flex items-start">
                  ...
                  <div>
                    <strong className="text-gray-900">Expert care</strong> - 2000+ families trust us as their best dog groomer in Madison with over 7 years serving the Cherokee Marsh community
                  </div>
                </li>
              </ul>
            </div>
            ...
            {/* Call to Action */}
            <div className="mt-12 bg-gradient-to-r from-emerald-600 to-teal-600 rounded-2xl p-8 md:p-12 text-white text-center">
