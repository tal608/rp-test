    ...
    <>
      ...
      <section ref={heroRef} className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="absolute inset-0 z-0">
          <Image
            src="/Hiking/playful-golden-retriever-outdoor-enrichment-waunakee-wi-river-paws.jpg"
            alt="Athletic Golden Retriever getting fitness-level exercise with a jolly ball at River Paws' purpose-built facility in Waunakee."
            fill
            className="object-cover"
            style={{ objectPosition: getImageObjectPosition("/Hiking/playful-golden-retriever-outdoor-enrichment-waunakee-wi-river-paws.jpg") }}
            priority
          />
            ...
            <div className="space-y-8">
              ...
              <div className="bg-gradient-to-r from-emerald-600 to-teal-600 rounded-2xl p-8 text-white">
                <div className="flex items-center mb-6">
                  ...
                  <h3 className="text-2xl font-bold">Package Deal Available!</h3>
                </div>
                <p className="text-emerald-100 mb-6">
                  After a morning of hiking, treat your pup to a grooming spa session in the afternoon!
                  Save time and money with our convenient hike-to-groom package.
                </p>
                <div className="bg-white/10 rounded-lg p-4">
                  <p className="text-sm text-emerald-200">
                    Contact us for package pricing and scheduling options.
                  </p>
                </div>
              </div>
            </div>
