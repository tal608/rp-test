      ...
      <section id="gallery-content" className="py-12 sm:py-16 md:py-24 px-4 sm:px-6 bg-gradient-to-b from-white to-blue-50">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mt-16 text-center">
            <div className="bg-gradient-to-r from-emerald-600 to-teal-600 rounded-3xl p-8 md:p-12 text-white max-w-4xl mx-auto">
              ...
              <a 
                ...
                className="inline-flex items-center px-6 sm:px-8 py-3 sm:py-4 bg-white text-emerald-600 rounded-full font-medium text-base sm:text-lg hover:scale-105 transition-all duration-300 shadow-xl min-h-[44px]"
