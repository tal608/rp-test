...
const focalPointMap: Record<string, { x: number; y: number }> = {
  ...
  'fresh-groom-doodle-grooming-deforest-wi-river-paws.jpg': { x: 50, y: 40 },  
  // Goldendoodle images
  ...
  'happy-terrier-mix-grass-waunakee-wi-river-paws.jpg': { x: 37, y: 36.1 },
  'playing-multiple-dogs-farm-field-sun-prairie-wi-river-paws.jpg': { x: 56.5, y: 51.5 },
  ...
  'joyful-golden-retriever-outdoor-enrichment-waunakee-wi-river-paws.jpg': { x: 50, y: 45 },
  ...
  'confident-mixed-pack-hiking-waunakee-wi-river-paws.jpg': { x: 60, y: 75 },
  ...
  'calm-golden-retriever-dog-bus-transport-madison-wi-river-paws.jpg': { x: 52, y: 35 },
